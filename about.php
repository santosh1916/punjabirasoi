    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <h3>Welcome to <strong>PUNJABI RASOI</strong></h3>
                        ...
                        <div class="member">
                            ...
                            <div class="member-info">
                                ...
                                <div class="social">
                                    ...
                                    <a href="https://github.com/rjcoding16" target="_blank"><i
                                            class="fab fa-github"></i></a>
                                    <a href="https://www.linkedin.com/" target="_blank"><i class="icofont-linkedin"
                                            target="_blank"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
                        <div class="member">
                            ...
                            <div class="member-info">
                                ...
                                <div class="social">
                                    <a href="https://twitter.com/"><i class="icofont-twitter" target="_blank"></i></a>
                                    <a href="https://github.com/" target="_blank"><i class="fab fa-github"></i></a>
                                    <a href="https://www.linkedin.com/"><i class="icofont-linkedin"
                                            target="_blank"></i></a>
                                </div>
                            </div>
                        </div>
