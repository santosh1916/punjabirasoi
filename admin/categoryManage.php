                ...
                <form action="partials/_categoryManage.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="createCategory" class="btn btn-sm btn-warning col-sm-3 offset-md-4"> Create </button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo '<tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button class="btn btn-sm btn-warning edit_cat" type="button" data-toggle="modal" data-target="#updateCat' .$catId. '">Edit</button>
