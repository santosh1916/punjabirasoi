...
<body>
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="viewfoodList.php?catid=' . $catId . '" class="btn btn-warning">View All</a>
                        </div>
                    </div>
                </div>';
            }
    ...
    <div class="container my-3" id="cont">
        ...
        <?php 
            $query = $_GET["search"];
            $sql = "SELECT * FROM `pizza` WHERE MATCH(foodName, foodDesc) against('$query')"; 
            $result = mysqli_query($conn, $sql);
            while($row = mysqli_fetch_assoc($result)){
                            ...
                            <div class="row justify-content-center">';
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        ...
                                        echo '<a href="viewCart.php"><button class="btn btn-warning mx-2">Go to Cart</button></a>';
                                    }
                                }
                                else{
                                    echo '<button class="btn btn-warning mx-2" data-toggle="modal" data-target="#loginModal">Add to Cart</button>';
                                }
                                echo '</form>
                                <a href="viewfood.php?foodid=' . $foodId . '"><button class="btn btn-warning">Quick View</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
