...
<style>
    ...
    .table-wrapper .btn.btn-warning {
        color: #000099;
        background: #ffbc05;
    }
    .table-wrapper .btn.btn-warning:hover {
        background: #15ff00;
    }
    .table-title .btn {		
        font-size: 13px;
        ...
        <div class="table-wrapper" id="empty">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-8">						
                        <a href="" class="btn btn-warning"><i class="material-icons">&#xE863;</i> <span>Refresh List</span></a>
