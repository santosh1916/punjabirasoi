...
echo '<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #000000">
      <a class="navbar-brand" href="index.php">PUNJABI RASOI</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <button class="btn btn-outline-warning my-2 my-sm-0" type="submit">Search<i
        class="fas fa-shopping-cart"></button></i>
      </form>';
        ...
        if($loggedin){
          echo '<ul class="navbar-nav mr-2">
            <li class="nav-item dropdown">
              ...
              <a href="viewCart.php"><button type="button" class="btn btn-warning mx-4" title="MyCart">
          ...
          <i class="bi bi-cart">My Cart(' .$count. ')</i>
                ...
                <a class="dropdown-item" href="partials/_logout.php"><button type="button" class="btn btn-warning">Logout Here</button></a>
              </div>
            </li>
          </ul>
