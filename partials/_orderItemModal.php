                            ...
                            <tbody>
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        $itemsql = "SELECT * FROM `pizza` WHERE foodId = $foodId";
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    ...
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle">'.$foodName. '</a></h5><span class="text-muted font-weight-normal font-italic d-block">Rs. ' .$foodPrice. '/-</span>
                                                    </div>
                                                    </div>
                                                </th>
